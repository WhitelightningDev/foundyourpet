  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white shadow-md rounded-2xl mt-10">
      ...
      <div>
        ...
        <p><strong>Email:</strong> <a href={`mailto:${owner?.email}`} className="text-blue-500 underline">{owner?.email || 'Not available'}</a></p>
        <p><strong>Phone:</strong> <a href={`tel:${owner?.contact}`} className="text-blue-500 underline">{owner?.contact || 'Not available'}</a></p>
      </div>
    </div>
  );
}
